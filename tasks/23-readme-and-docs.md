...
**Source:** `docs/plans/initial_design.md` — §19 Development approach (final docs)
...
- Reference the §18 success criteria so the docs map features to the measurable goals.
