...
**Source:** Reference example — `E:\unity\projects\cadet-agent` (`publish-npm.ps1`, `package.json`); design doc §1 (`npx cadet-token-saver init`), §19 ("genuinely usable npm package", "build/package scripts")
